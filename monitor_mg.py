...
def get_config_turno():
    ...
    if datetime.time(10, 0) <= agora < datetime.time(13, 0):
        return {"max": "12", "desc1": "10", "ciclo1": 3, "desc2": "8", "ciclo2": 6, "min": "6", "ciclo3": 10, "final_min": "6", "final_ciclo": 15}
    
    # Turno 13:00 às 15:00
    elif datetime.time(13, 0) <= agora < datetime.time(15, 0):
        return {"max": "12", "desc1": "10", "ciclo1": 3, "desc2": "8", "ciclo2": 6, "min": "6", "ciclo3": 8, "final_min": "6", "final_ciclo": 20}
    
    # Turno 15:00 às 16:30
    elif datetime.time(15, 0) <= agora < datetime.time(16, 30):
        return {"max": "12", "desc1": "10", "ciclo1": 5, "desc2": "8", "ciclo2": 6, "min": "6", "ciclo3": 5, "final_min": "6", "final_ciclo": 12}
...
async def run_monitor():
    ...
    async with async_playwright() as p:
        print(f"🚀 [SOMA - MG] Monitor Ativado | Configuração de Potência Atualizada", flush=True)
